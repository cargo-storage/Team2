        ...
        <div class="container">
			<form id="addForm" action="${contextPath}/bo/BoardAddAction.bo" method="post">	
				...
				<div align="right" class="mt-3">
					...
					<input class="btn btn-primary btn-md"  type="submit" value="글작성"/>
					<input class="btn btn-primary btn-md" type="reset" value="초기화"/>
					<a class="btn btn-primary btn-md" href="${contextPath}/bo/QuestionListAction.bo">글목록</a>
				</div>
			</form>
		</div>
		</div>
