             ...
             <div id="service" class="view">
				<div class="card">
					<div class="card-header">
						<h5 class="mb-0"><i class="far fa-question-circle" style="color: green"></i> <a class="card-link" data-toggle="collapse" href="#collapse1"> 모든 물품을 다 보관 할 수 있나요?</a></h5> 
					</div>
				...
				<div class="card">
					<div class="card-header">
						<h5 class="mb-0"><i class="far fa-question-circle" style="color: green"></i> <a class="card-link" data-toggle="collapse" href="#collapse2"> 물품의 입출 가능시간은 어떻게 되나요? </a></h5>
					</div>
				...
				<div class="card">
					<div class="card-header">
						<h5 class="mb-0"><i class="far fa-question-circle" style="color: green"></i> <a class="card-link" data-toggle="collapse" href="#collapse3"> 상담 및 견적은 어떻게 되나요?</a></h5>
					</div>
				...
				<div class="card">
					<div class="card-header">
						<h5 class="mb-0"><i class="far fa-question-circle" style="color: green"></i> <a class="card-link" data-toggle="collapse" href="#collapse4"> 장마철 습기 문제는 어떤가요? </a></h5>
					</div>
				...
				<div class="card">
					<div class="card-header">
						<h5 class="mb-0"><i class="far fa-question-circle" style="color: green"></i> <a class="card-link" data-toggle="collapse" href="#collapse5"> 보안문제는 어떤가요? </a></h5>
					</div>
