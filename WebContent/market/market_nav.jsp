...
<!-- 	                   <a class="nav-link" href="#houseinfo">이용안내</a> -->
	               ...
	               <li class="nav-item">
	                   <a class="nav-link" href="../mk/market.do">MARKET HOME</a>
	               </li>
	               <li class="nav-item">
	        ...
	        <c:set var="email" value="${sessionScope.mdto.email }"/>
          	...
          	<c:set var="admin" value="${sessionScope.mdto.admin }"/>
          		<c:if test="${admin == 1 }">
	        		<li class="nav-item">
	                	<a class="nav-link" href="#faq">물건등록<small>(관리자)</small></a>
	            	</li> 
            	</c:if>
            	<c:choose>
               	<c:when test="${email != null }">
	               	<li class="nav-item">         
	              		<a href="../me/logout.me" class="nav-link"><small>로그아웃 <i class="fas fa-arrow-alt-circle-right"></i></small></a>
	              	</li>
               	</c:when>
               	<c:otherwise>
               		<li class="nav-item">
