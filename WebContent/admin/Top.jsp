		...
		<ul class="sidebar navbar-nav">
			...
			<li class="nav-item dropdown">
				...
				aria-haspopup="true" aria-expanded="false">
					<i class="fas fa-fw fa-table"></i> <span>창고 상세보기</span>
				</a>
			...
			<li class="nav-item">
				<a class="nav-link" href="${contextPath}/ad/listTables?category=reservation">
					<i class="fas fa-fw fa-chart-area"></i> <span>예약 내역 관리</span>
				</a>
			</li>
			<li class="nav-item">
				<a class="nav-link" href="${contextPath}/ad/listTables?category=closed">
					<i class="fas fa-fw fa-chart-area"></i> <span>종료된 기록 열람</span>
				</a>
			</li>
			<li class="nav-item">
				<a class="nav-link" href="${contextPath}/ad/member_admin">
					<i class="fas fa-fw fa-chart-area"></i> <span>회원 정보 관리</span>
				</a>
			</li>
<!-- 			<li class="nav-item dropdown"> -->
